...
function Main() {
  return (
    ...
    <div className='relative left-52 p-16 bottom-[26rem]'>
      <img className='h-10 w-10 relative right-16 top-10 cursor-pointer' src="loc.jpg" alt="" />
    <input className='h-10 absolute left-12 text-white' type="type" placeholder=' Vadodara'/>
    <input className='h-10 w-[35rem] absolute left-[16.5rem]' type="text" placeholder='Search for restaurant,cuisine or a dish' />
    </div>
    </div>
    </>
  )
